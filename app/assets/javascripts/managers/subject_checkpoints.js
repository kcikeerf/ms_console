...
//			onDrop: zTreeOnDrop,
  ...
  //   	});
    ...
    function get_tree_data(subject, xue_duan){
        var sys_type_rid = $('.ckp_system').attr("value");
		if(subject == ''){
			init_tree(null, null, null);
			$('#file_upload').hide();
		}else{
			$.get('/checkpoints/get_tree_date_include_checkpoint_system',{subject: subject, xue_duan: xue_duan, ckp_system_rid: sys_type_rid},function(data){
